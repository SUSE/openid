...
$keypath = 'http://'.OPENID_SERVER.'/API.asmx/GetKey?username='.OPENID_USERNAME.'&password='.OPENID_PASSWORD.'&key='.$_REQUEST["key"];
$key = simplexml_load_file($keypath);
$sessionpath = 'http://'.OPENID_SERVER.'/API.asmx/GetSession?username='.OPENID_USERNAME.'&password='.OPENID_PASSWORD.'&key='.$_REQUEST["key"];
